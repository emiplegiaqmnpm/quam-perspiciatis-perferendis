...
Interactive docs and demos are availble on https://@emiplegiaqmnpm/quam-perspiciatis-perferendis.dev/#/docs/api.
...
- Install:
  ...
  ```bash
  > npm i -save @emiplegiaqmnpm/quam-perspiciatis-perferendis
  ```

- Require:

  ```javascript
  require('@emiplegiaqmnpm/quam-perspiciatis-perferendis')
...
```html
<script src="https://cdn.jsdelivr.net/gh/mattaylor/@emiplegiaqmnpm/quam-perspiciatis-perferendis@main/@emiplegiaqmnpm/quam-perspiciatis-perferendis.min.js"></script>
...
```javascript
const _ = require('@emiplegiaqmnpm/quam-perspiciatis-perferendis')
